...
import '@/layouts';
import Payment from '@/components/main/product-detail-layout/product-detail-11/payment/Payment';
import Info from '@/components/main/product-detail-layout/product-detail-11/info/Info';
...
const ProductDetailComponent11 = () => {
  return (
...
export default ProductDetailComponent11;