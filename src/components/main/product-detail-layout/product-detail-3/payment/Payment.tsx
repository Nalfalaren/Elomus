      ...
      <div className="product-detail-4__left__carousel">
        <div className="product-detail-4__left__carousel--other">
          {imgList.map((img, index) => (
            <div className="product-detail-4__left__carousel--other__item">
              <img src={img} alt={img} key={index}></img>
            </div>
          ))}
        </div>
        <Carousel fade className="product-detail-4__left__carousel--main">
          {imgList.map((img, index) => (
          ...
          <div key={info.id} className="product-detail-4__right__container">
              ...
              {info.rates.map((rate, index) =>
                rate ? (
                  <FontAwesomeIcon
                    icon={faStar}
                    key={index}
                    className="product-detail-4__right__container__rates--filled"
                  />
                ) : (
                  <FontAwesomeIcon
                    icon={faStar}
                    key={index}
                    className="product-detail-4__right__container__rates--unfilled"
                  />
                ),
              )}
            </div>
            ...
            <div className="product-detail-4__right__container__status">
              ...
              <span className="product-detail-4__right__container__status__brand">
                Brand:
                <p className="product-detail-4__right__container__status__tags">
                  {info.brand}
                </p>
              </span>
              <p>SKU: {info.SKU}</p>
