...
const Info = () => {
  ...
  const pageTitles = ['Description', 'Reviews', 'Shipping', 'Returns'];
  ...
  return (
    <div className="info-green">
      <div className="info-green__tabs">
        {pageTitles.map((title, index) => (
          <button
            key={index}
            className={`info-green__tabs__button ${currentPage === title ? 'active info-green__tabs__chosen' : ''}`}
      ...
      <div>
        ...
        {currentPage === 'Description' &&
          productInfo.map((info, index) => (
            <div key={index} className="info-green">
              <div className="info-green__intro">
                <h4>{info.intro}</h4>
                <div className="info-green__intro__overview">
                  <p>
                    <span>{info.overview.title}</span> {info.overview.content}
                  </p>
                </div>
              </div>
              <div className="info-green__intro__key">
              ...
              <div className="info-green__intro__prize">
              ...
              <div className="info-green__intro__others">
