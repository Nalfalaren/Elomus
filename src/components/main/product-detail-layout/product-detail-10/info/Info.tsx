...
const Info = () => {
  ...
  return (
    <div className="info-brown-2">
      <div className="info-brown-2__tabs">
        {pageTitles.map((title, index) => (
          <button
            key={index}
            className={`info-brown-2__tabs__button ${currentPage === title ? 'active info-brown-2__tabs__chosen' : ''}`}
      ...
      <div className="info-brown-2-content">
        <hr></hr>
        {currentPage === 'Description' &&
          productInfo.map((info, index) => (
            <div key={index} className="info-brown-2">
              <div className="info-brown-2__intro">
                <h4>{info.intro}</h4>
                <div className="info-brown-2__intro__overview">
                  <p>
                    <span>{info.overview.title}</span> {info.overview.content}
                  </p>
                </div>
              </div>
              <div className="info-brown-2__intro__key">
              ...
              <div className="info-brown-2__intro__prize">
              ...
              <div className="info-brown-2__intro__others">
        ...
        {currentPage === 'Reviews' && (
          <div className="info-brown-2">
            <h3 className="info-brown-2__reviews">Customer Reviews</h3>
